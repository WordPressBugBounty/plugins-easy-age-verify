...
Easy Age Verify was developed in the United States by 5 Star Plugins. For cannabis please visit our other plugin [Marijuana Age Verify](https://5starplugins.com/marijuana-website-age-verification/).

= SEE A DEMO =
**Visit a live demo with the standard plugin.**

[Adult Demo](https://freeadultageverify.5starplugins.com/) | [Vape Demo](https://freevapeageverify.5starplugins.com/) | [Alcohol Demo](https://freealcoholageverify.5starplugins.com/)
...
Receive priority email support after purchasing [Easy Age Verify Premium](https://5starplugins.com/easy-website-age-verification/).
...
* [Easy Age Verify](https://5starplugins.com/easy-website-age-verification/) plugin official page
* [Knowledge Base](https://support.5starplugins.com/collection/69-easy-age-verify)
* [Premium Support Center](https://5starplugins.com/get-support/)
* Plugin [updates and tips blog](https://5starplugins.com/category/easy-age-verify/)

**Love this plugin?** We'd love your [review](https://wordpress.org/support/plugin/easy-age-verify/reviews/?filter=5#new-post).
...
[Troubleshooting Guide](https://support.5starplugins.com/article/79-my-age-verify-window-is-not-popping-up)
...
If your question is not listed here visit our [Knowledge Base](https://support.5starplugins.com/collection/69-easy-age-verify).

== Screenshots ==
1. Adult Demo Display - Free
2. Alcohol Demo Display - Free
3. Vape Demo Display - Free
4. Options and settings in WordPress Dashboard - Free
5. Adult Demo Display - Premium Version
...
== Upgrade Notice ==
Update! Fixed languages path. Updated language files, fixed translation bugs
...
= 2.0.5 =
* Fixed extra character output issues.
...
= 1.8.3 =
* Updated: Better sanitization of disclaimer text to avoid potential XSS issues.
